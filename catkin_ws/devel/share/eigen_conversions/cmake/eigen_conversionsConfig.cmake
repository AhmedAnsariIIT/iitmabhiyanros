...
if("TRUE" STREQUAL "TRUE")
  set(eigen_conversions_SOURCE_PREFIX /home/faisal/catkin_ws/src/geometry-hydro-devel/eigen_conversions)
  set(eigen_conversions_DEVEL_PREFIX /home/faisal/catkin_ws/devel)
  ...
  set(eigen_conversions_INSTALL_PREFIX /home/faisal/catkin_ws/install)
...
if(NOT "/home/faisal/catkin_ws/src/geometry-hydro-devel/eigen_conversions/include;/usr/include/eigen3;/opt/ros/hydro/include" STREQUAL "")
  set(eigen_conversions_INCLUDE_DIRS "")
  set(_include_dirs "/home/faisal/catkin_ws/src/geometry-hydro-devel/eigen_conversions/include;/usr/include/eigen3;/opt/ros/hydro/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'eigen_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/faisal/catkin_ws/src/geometry-hydro-devel/eigen_conversions/${idir}'.  Ask the maintainer 'Tully Foote <tfoote@willowgarage.com>' to fix it.")
    endif()
    _list_append_unique(eigen_conversions_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "eigen_conversions")
