...
if("TRUE" STREQUAL "TRUE")
  set(move_base_msgs_SOURCE_PREFIX /home/faisal/catkin_ws/src/move_base_msgs)
  set(move_base_msgs_DEVEL_PREFIX /home/faisal/catkin_ws/devel)
  ...
  set(move_base_msgs_INSTALL_PREFIX /home/faisal/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'move_base_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'move_base_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/faisal/catkin_ws/src/move_base_msgs/${idir}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>' to fix it.")
    endif()
