...
if("TRUE" STREQUAL "TRUE")
  set(tf_SOURCE_PREFIX /home/faisal/catkin_ws/src/geometry-hydro-devel/tf)
  set(tf_DEVEL_PREFIX /home/faisal/catkin_ws/devel)
  set(tf_INSTALL_PREFIX "")
  set(tf_PREFIX ${tf_DEVEL_PREFIX})
else()
  set(tf_SOURCE_PREFIX "")
  set(tf_DEVEL_PREFIX "")
  set(tf_INSTALL_PREFIX /home/faisal/catkin_ws/install)
...
if(NOT "/home/faisal/catkin_ws/devel/include;/home/faisal/catkin_ws/src/geometry-hydro-devel/tf/include" STREQUAL "")
  set(tf_INCLUDE_DIRS "")
  set(_include_dirs "/home/faisal/catkin_ws/devel/include;/home/faisal/catkin_ws/src/geometry-hydro-devel/tf/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'tf' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Tully Foote <tfoote@willowgarage.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'tf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/faisal/catkin_ws/src/geometry-hydro-devel/tf/${idir}'.  Ask the maintainer 'Tully Foote <tfoote@willowgarage.com>' to fix it.")
    endif()
