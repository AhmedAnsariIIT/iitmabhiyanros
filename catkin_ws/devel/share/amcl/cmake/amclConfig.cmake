...
if("TRUE" STREQUAL "TRUE")
  set(amcl_SOURCE_PREFIX /home/faisal/catkin_ws/src/amcl)
  set(amcl_DEVEL_PREFIX /home/faisal/catkin_ws/devel)
  set(amcl_INSTALL_PREFIX "")
  set(amcl_PREFIX ${amcl_DEVEL_PREFIX})
else()
  set(amcl_SOURCE_PREFIX "")
  set(amcl_DEVEL_PREFIX "")
  set(amcl_INSTALL_PREFIX /home/faisal/catkin_ws/install)
...
if(NOT "/home/faisal/catkin_ws/devel/include;/home/faisal/catkin_ws/src/amcl/include" STREQUAL "")
  set(amcl_INCLUDE_DIRS "")
  set(_include_dirs "/home/faisal/catkin_ws/devel/include;/home/faisal/catkin_ws/src/amcl/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'amcl' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'amcl' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/faisal/catkin_ws/src/amcl/${idir}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>' to fix it.")
    endif()
